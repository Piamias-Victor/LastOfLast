    ...
    <main className="min-h-screen flex flex-col bg-white">
      ...
      <header className="fixed w-full z-50 bg-white/90 backdrop-blur-md border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <h1 className="text-xl font-medium text-pharmacy-primary">Pharmacy Planner</h1>
          <nav className="hidden md:flex space-x-8">
            <Link href="#" className="text-sm text-gray-600 hover:text-pharmacy-primary transition-colors">
              Fonctionnalités
            </Link>
            <Link href="#" className="text-sm text-gray-600 hover:text-pharmacy-primary transition-colors">
              Témoignages
          ...
          <Link 
            href="/editor" 
            className="hidden md:flex text-sm px-4 py-2 rounded-full bg-pharmacy-primary text-white hover:bg-opacity-90 transition-all"
          >
            Essayer
          </Link>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl md:text-5xl font-medium text-gray-900 leading-tight mb-6">
                Concevez votre espace pharmaceutique <span className="text-pharmacy-primary">avec précision</span>
              </h2>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/editor"
                  className="text-center px-8 py-4 bg-pharmacy-primary text-white rounded-full text-sm font-medium hover:shadow-lg transition-all"
                >
                  Commencer un nouveau plan
                </Link>
                <Link
                  href="#demo"
                  className="text-center px-8 py-4 bg-white border border-gray-200 text-gray-800 rounded-full text-sm font-medium hover:border-pharmacy-primary hover:text-pharmacy-primary transition-all"
                >
            ...
            <div className="relative">
              <div className="aspect-[4/3] bg-gray-50 rounded-2xl overflow-hidden shadow-lg">
                <div className="absolute inset-0 opacity-80 bg-gradient-to-br from-pharmacy-primary/5 to-pharmacy-primary/20"></div>
                <div className="p-6 relative z-10">
                  <div className="w-full h-full bg-white/80 rounded-xl shadow-sm border border-gray-100 p-4">
                    <div className="w-full h-8 bg-pharmacy-primary/10 rounded mb-4 flex items-center px-3">
                      <div className="w-3 h-3 rounded-full bg-pharmacy-primary mr-2"></div>
                      <div className="w-24 h-2 bg-pharmacy-primary/30 rounded-full"></div>
                    </div>
                    <div className="grid grid-cols-3 gap-3">
                      {[...Array(6)].map((_, i) => (
                        <div key={i} className="aspect-square bg-white rounded border border-gray-200 shadow-sm flex items-center justify-center">
                          <div className={`w-2/3 h-2/3 ${i % 3 === 0 ? 'bg-pharmacy-primary/20' : 'bg-gray-100'} rounded-md`}></div>
                        </div>
                      ))}
                    </div>
                  </div>
              ...
              <div className="absolute -bottom-6 -right-6 w-24 h-24 bg-pharmacy-primary rounded-full flex items-center justify-center text-white">
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h3 className="text-sm font-medium text-pharmacy-primary uppercase tracking-wider mb-3">Fonctionnalités</h3>
      ...
      <section id="demo" className="py-20 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h3 className="text-sm font-medium text-pharmacy-primary uppercase tracking-wider mb-3">Comment ça marche</h3>
              <h2 className="text-3xl font-medium text-gray-900 mb-6">Un processus simplifié en trois étapes</h2>
              
              <div className="space-y-8">
                {steps.map((step, index) => (
                  <div key={index} className="flex">
                    <div className="mr-4 flex-shrink-0">
                      <div className="w-10 h-10 rounded-full bg-pharmacy-primary text-white flex items-center justify-center font-medium">
                        {index + 1}
                      </div>
                    </div>
                    <div>
            ...
            <div className="bg-gray-50 rounded-2xl overflow-hidden shadow-lg">
              ...
              <div className="p-6">
                <h4 className="text-xl font-medium text-gray-900 mb-2">Visualisez votre espace avant de le créer</h4>
                <p className="text-gray-600 mb-4">Notre éditeur visuel vous permet de tester différentes configurations pour trouver l'agencement optimal.</p>
                <Link href="/editor" className="text-pharmacy-primary font-medium hover:underline inline-flex items-center">
                  Essayer maintenant
      ...
      {/* CTA final */}
      <section className="py-20 px-6 bg-pharmacy-primary">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-medium text-white mb-6">Prêt à transformer votre espace pharmaceutique?</h2>
          <p className="text-lg text-white text-opacity-80 mb-10">Rejoignez les centaines de pharmaciens qui optimisent déjà leur espace et améliorent l'expérience de leurs clients.</p>
          <Link
            href="/editor"
            className="inline-block px-8 py-4 bg-white text-pharmacy-primary rounded-full text-sm font-medium hover:shadow-lg transition-all"
          >
            Commencer gratuitement
          </Link>
          <p className="mt-4 text-sm text-white text-opacity-70">Aucune carte de crédit requise</p>
        </div>
      </section>
      ...
      <footer className="py-12 px-6 bg-gray-900 text-white">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-medium mb-4">Pharmacy Planner</h3>
              <p className="text-sm text-gray-400">La référence en matière de conception d'espaces pharmaceutiques.</p>
            </div>
            
            <div>
              <h4 className="text-sm font-medium uppercase tracking-wider text-gray-400 mb-4">Produit</h4>
            ...
            <div>
              <h4 className="text-sm font-medium uppercase tracking-wider text-gray-400 mb-4">Ressources</h4>
              <ul className="space-y-2">
            ...
            <div>
              <h4 className="text-sm font-medium uppercase tracking-wider text-gray-400 mb-4">Légal</h4>
              <ul className="space-y-2">
